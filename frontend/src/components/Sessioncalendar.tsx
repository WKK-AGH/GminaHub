            ...
            <div className="grid grid-cols-7">
                {days.map((day, i) => {
                    ...
                    return (
                        ...
                        >
                            <span
                                className={`text-xs font-semibold ${isSelected ? 'text-white' : isToday ? 'text-[#B91C1C]' : 'text-slate-700'}`}
                            >
                                {day.getDate()}
                            </span>
                            ...
                            {selectedSessions.map((s) => (
                                ...
                                >
                                    ...
                                    {s.status === 'ACTIVE' && (
                                        <Link
                                            to={`/live/${s.id}`}
                                            className="text-[#B91C1C] font-bold text-xs"
                                        >
                                            <Radio className="w-3 h-3 inline" /> Na żywo
                                        </Link>
                                    )}
                                </div>
                            ))}
