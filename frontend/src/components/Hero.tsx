import { CalendarDays, MapPin, Clock, FileDown, ListFilter, Calendar, ArrowRight, Radio, Users, FileText } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-5">
                ...
                <p className="text-slate-400 text-lg leading-relaxed max-w-md font-light">
                  Transparentny dostęp do prac samorządu. Śledź głosowania, agendy sesji i uchwały Rady Gminy w czasie rzeczywistym.
                </p>
              </div>
            ...
            <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6 md:p-8 space-y-6">
              <div className="flex items-center gap-3 pb-5 border-b border-slate-700">
                ...
                <div>
                  <p className="text-xs font-bold text-blue-400 uppercase tracking-widest">Najbliższe posiedzenie</p>
                  <p className="text-white font-extrabold text-lg leading-snug">XXXIV Sesja Zwyczajna</p>
                </div>
              </div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-center gap-3 text-slate-300">
                  ...
                  <span className="font-semibold">Główna Sala Konferencyjna (Ratusz)</span>
                </div>
                <div className="flex items-center gap-3 text-slate-300">
              ...
              <div className="border-t border-slate-700 pt-4 space-y-3">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-bold text-slate-200">Szczegółowa agenda</span>
                  </div>
                  <span className="text-xs font-bold text-slate-500">{showAgenda ? 'Zwiń ▲' : 'Rozwiń ▼'}</span>
                </button>

                {showAgenda && (
                  <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-3 space-y-1">
                    {agendaPoints.map(point => (
                      <div key={point.id} className="flex items-start gap-2.5 py-2 border-b border-slate-700/50 last:border-0">
                        <span className="font-mono text-xs font-bold text-slate-500 mt-0.5 flex-shrink-0">{point.id}.</span>
                        <p className="text-sm text-slate-300 leading-snug">{point.title}</p>
                      </div>
                    ))}
                  </div>
                )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-sm mx-auto">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-lg font-extrabold text-slate-900 tracking-tight">Kalendarz posiedzeń — Maj 2026</h2>
            </div>
