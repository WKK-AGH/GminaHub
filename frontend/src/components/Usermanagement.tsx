...
import { authApi, ROLE_LABEL, usersApi, type UserListItem, type UserRole } from '../api/api';
                ...
                <div className="max-w-4xl mx-auto flex flex-wrap items-start justify-between gap-4">
                    <div>
                        ...
                        <p className="text-slate-500 text-sm mt-1">
                            Tworzenie kont i przypisywanie ról systemowych
                        </p>
                    </div>
                    <button
                        onClick={() => {
                        ...
                        <form onSubmit={handleSubmit} className="p-5 space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-400 mt-1">
                                    Minimum 3 znaki, użytkownik użyje go do logowania
                                </p>
                            </div>
                                        ...
                                        <tr key={user.id} className="hover:bg-slate-50 transition">
                                            <td className="px-4 py-3">
                                                <div className="flex items-center gap-2.5">
                                                    <div className="w-7 h-7 rounded bg-[#B91C1C] flex items-center justify-center text-white text-xs font-bold shrink-0">
                                                        {user.firstName[0]}
                                                        {user.lastName[0]}
                                                    </div>
                                            ...
                                            <td className="px-4 py-3">
                                                <span
                                                    className={`text-xs font-semibold px-2 py-0.5 rounded border ${cfg.className}`}
                                                >
                                                    {ROLE_LABEL[role]}
                                                </span>
                                            </td>
